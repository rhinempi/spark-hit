...
import uni.bielefeld.cmg.sparkhit.util.ParameterForScriptPiper;
 ...
 * Sparkhit-piper. It can also be specified at the input options
...
public class MainOfPiper {
    ...
    public static void main(String[] args){
        ...
        info.readParagraphedMessages("SparkHit ScriptPiper initiating ... \ninterpreting parameters.");
        info.screenDump();

        ParameterForScriptPiper parameterP = null;
        try {
            parameterP = new ParameterForScriptPiper(args);
        } catch (IOException e) {
            e.fillInStackTrace();
        } catch (ParseException e) {
            e.fillInStackTrace();
        }
        DefaultParam param = parameterP.importCommandLine();
